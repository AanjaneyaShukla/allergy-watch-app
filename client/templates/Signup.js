...
var url= 'https://allergywatch.herokuapp.com/Signup/'    
  ...
  render(){
        return (
                 <Content style={{ alignSelf: 'center', marginTop: 60, marginBottom: 10 }}>
                 <ScrollView>
                    <List>
                        <ListItem>
                    ...
                    <Button rounded disabled={this.buttonIsDisabled()} style={{width:200, alignSelf: 'center', marginTop: 5, marginBottom: 10 }} onPress={this.submitSignup}>
                        Sign Up
                    </Button>
                </ScrollView>        
              </Content>
